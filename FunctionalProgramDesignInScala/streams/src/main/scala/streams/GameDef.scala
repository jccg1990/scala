...
trait GameDef {
  ...
  case object Left extends Move {
    override def move(block: Block): Block = block.left
  }

  case object Right extends Move {
    override def move(block: Block): Block = block.right
  }

  case object Up extends Move {
    override def move(block: Block): Block = block.up
  }

  case object Down extends Move {
    override def move(block: Block): Block = block.down
  }
